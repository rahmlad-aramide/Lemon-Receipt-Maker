...
**Step 1:** Add a new function declaration named `getPrices()`, and give it the parameter of `taxBoolean`.
...
**Step 8:** You're finshed with the `getPrices()` function, and now you're ready to code another function. This second function is named `getDiscount()` function, and it accepts two parameters: the `taxBoolean` and the `guests` parameter. 
